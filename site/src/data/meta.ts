...
export const AMETA: Record<string, any> = {
  ...
  'rikon-tsuma-mushi-sareru':           { phases: ['切り出された直後'], kanshin: ['気持ち'], kids: false, spouse_contact: true, pick: true, rank: 8, pri: 3, tag: '気持ち', route: 'mitei' },
  'rikon-tsuma-mushi-itsumade':         { phases: ['切り出された直後'], kanshin: ['気持ち'], kids: false, spouse_contact: true, pri: 2, tag: '気持ち', route: 'mitei' },
  'rikon-tsuma-mushi-koekake':          { phases: ['切り出された直後'], kanshin: ['気持ち'], kids: false, spouse_contact: true, pri: 2, tag: '気持ち', route: 'mitei' },
  'rikon-tsuma-fukigen-tsukareta':      { phases: ['切り出された直後'], kanshin: ['気持ち'], kids: false, spouse_contact: true, pri: 2, tag: '気持ち', route: 'mitei' },
  'rikon-tsuma-ga-kowai':              { phases: ['切り出された直後'], kanshin: ['気持ち'], kids: false, spouse_contact: true, pick: true, rank: 10, pri: 2, tag: '気持ち', route: 'mitei' },
...
export const QMETA: Record<string, any> = {
  ...
  'rikon-dansei-dv-soudan-dekiru':      { phases: ['切り出された直後'], kanshin: ['気持ち', '相談'] },
  'rikon-kodomo-natsuiteru-gaman':      { phases: ['切り出された直後'], kanshin: ['子ども'], kids: true },
  'rikon-tsuma-mushi-shokuji':          { phases: ['切り出された直後'], kanshin: ['気持ち'] },
  'rikon-tsuma-mushi-kaisha':           { phases: ['切り出された直後'], kanshin: ['相談'] },
  'rikon-tsuma-mushi-kiroku':           { phases: ['切り出された直後'], kanshin: ['気持ち'] },
  'rikon-tsuma-mushi-nenmatsu':         { phases: ['切り出された直後'], kanshin: ['気持ち'] },
  'rikon-tsuma-mushi-lineblock':        { phases: ['切り出された直後'], kanshin: ['気持ち'] },
  'rikon-tsuma-mushi-kodomo-tsutae':    { phases: ['切り出された直後'], kanshin: ['子ども'] },
  'rikon-tsuma-fukigen-yotei':          { phases: ['切り出された直後'], kanshin: ['気持ち'] },
  'rikon-tsuma-fukigen-jibun-okoru':    { phases: ['切り出された直後'], kanshin: ['気持ち'] },
  'rikon-donarareta-memo':              { phases: ['切り出された直後'], kanshin: ['気持ち'] },
