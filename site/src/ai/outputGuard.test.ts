...
expect('養育費+具体額(長文段落)も差し止め', '養育費は、家庭裁判所の養育費算定表という公式の物差しがあり、あなたの年収・相手の年収・お子さんの人数と年齢で標準的な月額の目安が決まります。たとえば子1人（8歳）で、あなたの年収500万・相手の年収100万なら月4〜6万円が目安です。', true, false, 'sealed_amount');
